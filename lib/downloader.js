...
module.exports = {
    download: (req, res, video_url) => {
        ...
        videos[vidHash] = {
            ...
            status: "downloading",
            viewer_url: "23.96.56.110/videos/"+vidHash+".mp4"
        }
    
        //spawn a python bot that downloads the movie
        //requires that youtube-dl be installed and invokable via bash
        let downloadCmd = `youtube-dl '${video_url}' -o 'videos/%(id).%(ext)s' -f 'bestvideo+bestaudio/best' --recode-video mp4 --write-info-json`
